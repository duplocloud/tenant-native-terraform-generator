...
export aws_services_project="aws-services" #  Project name for admin-tenant, Default is aws-services.
export app_project="app" #  Project name for app, Default is app.
